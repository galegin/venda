...
type
  ...
  function StrToTipoRetorno(AMensagem : String) : RTipoRetornoSefaz;
...
const
  LTipoStatusSefaz : Array [0..24] of RTipoStatusSefaz = (
   (cStat: 100; xMotivo: 'Autorizado o uso da NF-e'                               ; tStatus: tsAutorizacao ),
   (cStat: 101; xMotivo: 'Cancelamento de NF-e homologado'                        ; tStatus: tsCancelamento),
   (cStat: 102; xMotivo: 'Inutilização de número homologado'                      ; tStatus: tsInutilizacao),
   (cStat: 103; xMotivo: 'Lote recebido com sucesso'                              ; tStatus: tsProcessado  ),
   (cStat: 104; xMotivo: 'Lote processado'                                        ; tStatus: tsProcessado  ),
   (cStat: 105; xMotivo: 'Lote em processamento'                                  ; tStatus: tsProcessado  ),
   (cStat: 106; xMotivo: 'Lote não localizado'                                    ; tStatus: tsAutorizacao ),
   (cStat: 107; xMotivo: 'Serviço em Operação'                                    ; tStatus: tsProcessado  ),
   (cStat: 108; xMotivo: 'Serviço Paralisado Momentaneamente (curto prazo)'       ; tStatus: tsContingencia),
   (cStat: 109; xMotivo: 'Serviço Paralisado sem Previsão'                        ; tStatus: tsContingencia),
   (cStat: 110; xMotivo: 'Uso Denegado'                                           ; tStatus: tsCancelamento),
   (cStat: 111; xMotivo: 'Consulta cadastro com uma ocorrência'                   ; tStatus: tsProcessado  ),
   (cStat: 112; xMotivo: 'Consulta cadastro com mais de uma ocorrência'           ; tStatus: tsProcessado  ),
   (cStat: 124; xMotivo: 'EPEC Autorizado'                                        ; tStatus: tsProcessado  ),
   (cStat: 128; xMotivo: 'Lote de Evento Processado'                              ; tStatus: tsProcessado  ),
   (cStat: 135; xMotivo: 'Evento registrado e vinculado a NF-e'                   ; tStatus: tsAutorizacao ),
   (cStat: 136; xMotivo: 'Evento registrado, mas não vinculado a NF-e'            ; tStatus: tsAutorizacao ),
   (cStat: 137; xMotivo: 'Nenhum documento localizado para o Destinatário'        ; tStatus: tsProcessado  ),
   (cStat: 138; xMotivo: 'Documento localizado para o Destinatário'               ; tStatus: tsProcessado  ),
   (cStat: 139; xMotivo: 'Pedido de Download processado'                          ; tStatus: tsProcessado  ),
   (cStat: 140; xMotivo: 'Download disponibilizado'                               ; tStatus: tsProcessado  ),
   (cStat: 142; xMotivo: 'Ambiente de Contingência EPEC bloqueado para o Emitente'; tStatus: tsAutorizacao ),
   (cStat: 150; xMotivo: 'Autorizado o uso da NF-e, autorização fora de prazo'    ; tStatus: tsAutorizacao ),
   (cStat: 151; xMotivo: 'Cancelamento de NF-e homologado fora de prazo'          ; tStatus: tsCancelamento),
   (cStat: 204; xMotivo: 'Duplicidade de NF-e [nRec:999999999999999]'             ; tStatus: tsAutorizacao ));
...
begin
  ...
  for I := 0 to High(LTipoStatusSefaz) do
    with LTipoStatusSefaz[I] do
      if Result.cStat = cStat then begin
...
begin
  Result.tStatus := tsRejeicao;
  Result.cStat := -1;
  Result.xMotivo := AMensagem;

  AMensagem := TmString.RemoveAcento(AMensagem);

  for I := 0 to High(LTipoStatusSefaz) do
    with LTipoStatusSefaz[I] do
      if TmString.StartsWiths(LowerCase(AMensagem), LowerCase(xMotivo)) then begin
        Result.tStatus := tStatus;
        Result.cStat := cStat;
      end;
end;
...
344|Rejeição: Duplicidade de NF-e informada na Exportação Indireta (Chave de Acesso informada mais de ma vez)
